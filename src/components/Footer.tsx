          ...
          <Grid container spacing={6}>
            ...
            <Grid item xs={12} md={3}>
              <motion.div whileHover={{ scale: 1.05 }}>
                <Box textAlign={{ xs: "center", md: "left" }}>
                  ...
                  >
                    <Image src="/images/logo.jpg" alt="Shield Logo" width={120} height={120} />
                  </Box>
            ...
            <Grid item xs={12} md={3}>
              ...
              >
                ...
                {["Our Blog", "About Us", "Media", "Privacy Policy", "FAQ"].map((text) => (
                        ...
                        <IconButton
                          ...
                          sx={{
                            ...
                            "&:hover": {
                              background: "#ff4d4d",
                              color: "#fff",
                              boxShadow: "0 0 10px rgba(255,77,77,0.7), 0 0 20px rgba(255,77,77,0.4)",
                            },
                            transition: "all 0.3s",
                          }}
                          size="medium"
